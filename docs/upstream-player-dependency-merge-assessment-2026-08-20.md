...
| ---: | --- | --- | --- | --- | --- |
| 既有任务续修 | `E11` | Exo/App | 压缩音频输出、跳转释放状态、隧道一致性与起播恢复 | 2026-09-21 获批 A 已实现准入/属性一致、同媒体/音轨/路由 PCM 成功后的有界故障记忆及 typed stuck 分类；64 项定向用例、TV32 Debug APK/CRC/v2 签名通过，IJK 通用超时兼容保持。无设备，Sony 与健康 DSP/HDMI 的速度/性能未验；API31 多路环境不共享经验。B 保留原 10 秒兜底，待真实门槛/起播对照再缩短；C 暂缓。最终 APK SHA-256 `4093aeff27e55101e6ba199a78e77fd5d1c4bc608aa8f89aeac7939131b0c4f9`；guard `E11-audio-startup-admission` 原子提交/tag，来源/验收/回滚见唯一文档 | [E11-exo-compressed-audio-direct.md](E11-exo-compressed-audio-direct.md) |
