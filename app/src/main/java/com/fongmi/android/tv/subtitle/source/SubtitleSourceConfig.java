...
public final class SubtitleSourceConfig {
    ...
    public List<String> getLanguages(){return languages==null?Collections.emptyList():languages;} public List<String> getFormats(){return formats==null?Collections.emptyList():formats;} public Map<String,String> getHeaders(){return headers==null?Collections.emptyMap():headers;} public JsonObject getParams(){return params==null?new JsonObject():params;}
